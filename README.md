...
As seen in the screenshot, a slicer allows users to filter the entire dashboard by Year. This enables focused analysis on specific periods, such as comparing performance between 2017, 2018, 2019, etc.

Data-driven Insights:

The dashboard allows users to interact with the charts to drill down into specific dates and instantly see the corresponding OHLC (Open, High, Low, Close) values and volume, facilitating quick, granular analysis.
